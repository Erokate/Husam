...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === 'adam') {
    msg.reply('Efendim? Beni Çağırdın.');
  }
  if (msg.content.toLowerCase() === 'piç') {
    msg.channel.sendMessage('@Furkan Adar#4174 Biri Seni Çağırıyor!')
  }
...
if (msg.content.toLowerCase() === prefix + 'adam' ) {
 msg.channel.sendMessage('Adam mı? Yiğit Eren Güner adamdır!')
}
if (msg.content.toLowerCase() === prefix + 'hüsam' ) {
 msg.channel.sendMessage('https://resimag.com/p1/b0f6f523e93.jpeg')
}
});
